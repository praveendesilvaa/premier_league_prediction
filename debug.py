...
print("Initial data shape:", matches.shape)
print("Initial columns:", matches.columns)

matches["date"] = pd.to_datetime(matches["date"])
print("Data types after date conversion:", matches.dtypes)
...
print("Data after encoding and feature creation:")
print(matches.head())
...
print("Data after rolling averages:")
print(matches_rolling.head())
print("Data types after rolling averages:", matches_rolling.dtypes)
...
print("Data before dropping NA values:")
print(matches_rolling.head())
...
def preprocess_input(team1, team2, df):
    ...
    def get_team_rolling_averages(team):
        ...
        print(f"Rolling averages for {team}:")
        print(averages)
